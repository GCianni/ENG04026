...
""" Balanced datasets and its impacts on Machine Learning Models
    Tested Model: Logistic Regression, SGD Classifier, SLP, MLP
    Downsampling data lenght: 212 
...
for i, model in enumerate(models):
    pipeline(model, names[i], X_train, X_test, y_train, y_test,'Downsampling_BCW_')