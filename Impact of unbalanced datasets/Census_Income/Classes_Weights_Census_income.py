...
SAVE_FIG_PATH =r'C:/Users/55519/Desktop/UFRGS/Matérias/ENG04026 - Tópicos Especiais em Instrumentação II/Materiais/Trabalhos/Lab01/scr/LAB_A/relatorio/fig/'
FIG_BASE_LABEL='Classes_Weights_Census_Income_'
...
for i, model in enumerate(models):
    ...
    plt.show()
    #plt.savefig(SAVE_FIG_PATH+FIG_BASE_LABEL+names[i]+'.png') 
